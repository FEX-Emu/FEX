...
static size_t fexfn_impl_libxcb_xfixes_FEX_usable_size(void* a_0) { return malloc_usable_size(a_0); }

static void fexfn_impl_libxcb_xfixes_FEX_free_on_host(void* a_0) { free(a_0); }
