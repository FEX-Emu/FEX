...
static void InitializeExtensions(xcb_connection_t* c) { FEX_xcb_xfixes_init_extension(c, &xcb_xfixes_id); }
...
xcb_xfixes_get_cursor_image_and_name_reply(xcb_connection_t* a_0, xcb_xfixes_get_cursor_image_and_name_cookie_t a_1, xcb_generic_error_t** a_2) {
