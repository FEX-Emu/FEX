...
#else
const wl_interface* lookup_wl_interface(guest_layout<const wl_interface*> interface) { return interface.force_get_host_pointer(); }
#endif
...
static wl_proxy* fex_wl_proxy_marshal_array(
  wl_proxy* proxy, uint32_t opcode, guest_layout<wl_argument*> args, guest_layout<const wl_interface*> guest_interface,
...
extern "C" wl_proxy*
fexfn_impl_libwayland_client_wl_proxy_marshal_array_constructor_versioned(wl_proxy* proxy, uint32_t opcode, guest_layout<wl_argument*> args, guest_layout<const wl_interface*> interface, uint32_t version) {
  return fex_wl_proxy_marshal_array(proxy, opcode, args, interface, true, version, std::nullopt);
}

extern "C" wl_proxy*
fexfn_impl_libwayland_client_wl_proxy_marshal_array_constructor(wl_proxy* proxy, uint32_t opcode, guest_layout<wl_argument*> args, guest_layout<const wl_interface*> interface) {
  return fex_wl_proxy_marshal_array(proxy, opcode, args, interface, true, std::nullopt, std::nullopt);
}

extern "C" wl_proxy*
fexfn_impl_libwayland_client_wl_proxy_marshal_array_flags(wl_proxy* proxy, uint32_t opcode, guest_layout<const wl_interface*> interface, uint32_t version, uint32_t flags, guest_layout<wl_argument*> args) {
...
fexfn_impl_libwayland_client_wl_proxy_add_listener(struct wl_proxy* proxy, guest_layout<void (**)(void)> callback_table_raw, void* data) {
  ...
  for (int i = 0; i < interface->event_count; ++i) {
    ...
    if (signature == "") {
      ...
      FEXCore::FinalizeHostTrampolineForGuestFunction((FEXCore::HostToGuestTrampolinePtr*)callback, (void*)CallGuestPtrWithWaylandArray<void, void*, wl_proxy*>);
      ...
      FEXCore::FinalizeHostTrampolineForGuestFunction((FEXCore::HostToGuestTrampolinePtr*)callback, (void*)CallGuestPtrWithWaylandArray<void, void*, wl_proxy*, int32_t, int32_t>);
      ...
      FEXCore::FinalizeHostTrampolineForGuestFunction((FEXCore::HostToGuestTrampolinePtr*)callback, (void*)CallGuestPtrWithWaylandArray<void, void*, wl_proxy*, uint32_t, wl_surface*>);
...
int fexfn_impl_libwayland_client_fex_wl_get_interface_event_count(wl_proxy* proxy) { return get_proxy_interface(proxy)->event_count; }
