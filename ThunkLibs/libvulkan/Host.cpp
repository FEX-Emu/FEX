...
VULKAN_DEFAULT_CUSTOM_REPACK(VkAccelerationStructureCreateInfo2KHR)
...
// VULKAN_DEFAULT_CUSTOM_REPACK(VkAccelerationStructureGeometryMicromapDataKHR)
...
VULKAN_DEFAULT_CUSTOM_REPACK(VkAccelerationStructureTrianglesOpacityMicromapKHR)
...
VULKAN_DEFAULT_CUSTOM_REPACK(VkBindHeapInfoEXT)
...
VULKAN_DEFAULT_CUSTOM_REPACK(VkBindIndexBuffer3InfoKHR)
...
VULKAN_DEFAULT_CUSTOM_REPACK(VkBindTransformFeedbackBuffer2InfoEXT)
VULKAN_DEFAULT_CUSTOM_REPACK(VkBindVertexBuffer3InfoKHR)
...
VULKAN_DEFAULT_CUSTOM_REPACK(VkBufferDeviceAddressAlignmentAllocateInfoVALVE)
...
// VULKAN_DEFAULT_CUSTOM_REPACK(VkCommandBufferInheritanceDescriptorHeapInfoEXT)
...
VULKAN_DEFAULT_CUSTOM_REPACK(VkConditionalRenderingBeginInfo2EXT)
...
VULKAN_DEFAULT_CUSTOM_REPACK(VkCooperativeMatrixProperties2EXT)
...
// VULKAN_DEFAULT_CUSTOM_REPACK(VkCopyDeviceMemoryImageInfoKHR)
// VULKAN_DEFAULT_CUSTOM_REPACK(VkCopyDeviceMemoryInfoKHR)
...
VULKAN_DEFAULT_CUSTOM_REPACK(VkDataGraphOpticalFlowImageFormatInfoARM)
VULKAN_DEFAULT_CUSTOM_REPACK(VkDataGraphOpticalFlowImageFormatPropertiesARM)
...
VULKAN_DEFAULT_CUSTOM_REPACK(VkDataGraphPipelineNeuralStatisticsCreateInfoARM)
VULKAN_DEFAULT_CUSTOM_REPACK(VkDataGraphPipelineOpticalFlowCreateInfoARM)
VULKAN_DEFAULT_CUSTOM_REPACK(VkDataGraphPipelineOpticalFlowDispatchInfoARM)
...
VULKAN_DEFAULT_CUSTOM_REPACK(VkDataGraphPipelineResourceInfoImageLayoutARM)
...
VULKAN_DEFAULT_CUSTOM_REPACK(VkDataGraphPipelineSessionNeuralStatisticsCreateInfoARM)
// VULKAN_DEFAULT_CUSTOM_REPACK(VkDataGraphPipelineShaderModuleCreateInfoARM)
VULKAN_DEFAULT_CUSTOM_REPACK(VkDataGraphPipelineSingleNodeConnectionARM)
// VULKAN_DEFAULT_CUSTOM_REPACK(VkDataGraphPipelineSingleNodeCreateInfoARM)
...
// VULKAN_DEFAULT_CUSTOM_REPACK(VkDescriptorSetAndBindingMappingEXT)
...
// VULKAN_DEFAULT_CUSTOM_REPACK(VkDeviceFaultDebugInfoKHR)
// VULKAN_DEFAULT_CUSTOM_REPACK(VkDeviceFaultInfoEXT)
VULKAN_DEFAULT_CUSTOM_REPACK(VkDeviceFaultInfoKHR)
// VULKAN_DEFAULT_CUSTOM_REPACK(VkDeviceFaultShaderAbortMessageInfoKHR)
...
VULKAN_DEFAULT_CUSTOM_REPACK(VkDeviceMemoryCopyKHR)
VULKAN_DEFAULT_CUSTOM_REPACK(VkDeviceMemoryImageCopyKHR)
...
VULKAN_DEFAULT_CUSTOM_REPACK(VkDispatchIndirect2InfoKHR)
VULKAN_DEFAULT_CUSTOM_REPACK(VkDispatchParametersARM)
...
VULKAN_DEFAULT_CUSTOM_REPACK(VkDrawIndirect2InfoKHR)
VULKAN_DEFAULT_CUSTOM_REPACK(VkDrawIndirectCount2InfoKHR)
...
VULKAN_DEFAULT_CUSTOM_REPACK(VkFormatProperties4KHR)
...
VULKAN_DEFAULT_CUSTOM_REPACK(VkGpaDeviceClockModeInfoAMD)
VULKAN_DEFAULT_CUSTOM_REPACK(VkGpaDeviceGetClockInfoAMD)
VULKAN_DEFAULT_CUSTOM_REPACK(VkGpaSampleBeginInfoAMD)
VULKAN_DEFAULT_CUSTOM_REPACK(VkGpaSessionCreateInfoAMD)
...
VULKAN_DEFAULT_CUSTOM_REPACK(VkImageCreateFlags2CreateInfoKHR)
VULKAN_DEFAULT_CUSTOM_REPACK(VkImageCreateInfo)
// VULKAN_DEFAULT_CUSTOM_REPACK(VkImageDescriptorInfoEXT)
...
VULKAN_DEFAULT_CUSTOM_REPACK(VkImageStencilUsage2CreateInfoKHR)
...
VULKAN_DEFAULT_CUSTOM_REPACK(VkImageTilingControlCreateInfoEXT)
VULKAN_DEFAULT_CUSTOM_REPACK(VkImageUsageFlags2CreateInfoKHR)
...
VULKAN_DEFAULT_CUSTOM_REPACK(VkImageViewUsage2CreateInfoKHR)
...
VULKAN_DEFAULT_CUSTOM_REPACK(VkIndirectCommandsLayoutPushDataTokenNV)
...
VULKAN_DEFAULT_CUSTOM_REPACK(VkMemoryMarkerInfoAMD)
...
VULKAN_DEFAULT_CUSTOM_REPACK(VkMemoryRangeBarrierKHR)
// VULKAN_DEFAULT_CUSTOM_REPACK(VkMemoryRangeBarriersInfoKHR)
...
// VULKAN_DEFAULT_CUSTOM_REPACK(VkOpaqueCaptureDataCreateInfoEXT)
...
VULKAN_DEFAULT_CUSTOM_REPACK(VkPerfHintInfoQCOM)
...
VULKAN_DEFAULT_CUSTOM_REPACK(VkPhysicalDeviceBufferDeviceAddressAllocationAlignmentFeaturesVALVE)
VULKAN_DEFAULT_CUSTOM_REPACK(VkPhysicalDeviceBufferDeviceAddressAllocationAlignmentPropertiesVALVE)
...
VULKAN_DEFAULT_CUSTOM_REPACK(VkPhysicalDeviceCooperativeMatrixConversionFeaturesQCOM)
VULKAN_DEFAULT_CUSTOM_REPACK(VkPhysicalDeviceCooperativeMatrixDecodeVectorFeaturesNV)
...
VULKAN_DEFAULT_CUSTOM_REPACK(VkPhysicalDeviceCooperativeMatrixInfo2EXT)
VULKAN_DEFAULT_CUSTOM_REPACK(VkPhysicalDeviceCooperativeMatrixMaintenance1FeaturesEXT)
...
VULKAN_DEFAULT_CUSTOM_REPACK(VkPhysicalDeviceDataGraphNeuralAcceleratorStatisticsFeaturesARM)
VULKAN_DEFAULT_CUSTOM_REPACK(VkPhysicalDeviceDataGraphOpticalFlowFeaturesARM)
...
VULKAN_DEFAULT_CUSTOM_REPACK(VkPhysicalDeviceDescriptorHeapFeaturesEXT)
VULKAN_DEFAULT_CUSTOM_REPACK(VkPhysicalDeviceDescriptorHeapPropertiesEXT)
VULKAN_DEFAULT_CUSTOM_REPACK(VkPhysicalDeviceDescriptorHeapTensorPropertiesARM)
...
VULKAN_DEFAULT_CUSTOM_REPACK(VkPhysicalDeviceDeviceAddressCommandsFeaturesKHR)
...
VULKAN_DEFAULT_CUSTOM_REPACK(VkPhysicalDeviceElapsedTimerQueryFeaturesQCOM)
...
VULKAN_DEFAULT_CUSTOM_REPACK(VkPhysicalDeviceExtendedFlagsFeaturesKHR)
...
VULKAN_DEFAULT_CUSTOM_REPACK(VkPhysicalDeviceFaultFeaturesKHR)
VULKAN_DEFAULT_CUSTOM_REPACK(VkPhysicalDeviceFaultPropertiesKHR)
...
VULKAN_DEFAULT_CUSTOM_REPACK(VkPhysicalDeviceGpaFeaturesAMD)
VULKAN_DEFAULT_CUSTOM_REPACK(VkPhysicalDeviceGpaProperties2AMD)
VULKAN_DEFAULT_CUSTOM_REPACK(VkPhysicalDeviceGpaPropertiesAMD)
...
VULKAN_DEFAULT_CUSTOM_REPACK(VkPhysicalDeviceImageProcessing3FeaturesQCOM)
...
VULKAN_DEFAULT_CUSTOM_REPACK(VkPhysicalDeviceImageTilingControlFeaturesEXT)
...
VULKAN_DEFAULT_CUSTOM_REPACK(VkPhysicalDeviceInternallySynchronizedQueuesFeaturesKHR)
...
VULKAN_DEFAULT_CUSTOM_REPACK(VkPhysicalDeviceMaintenance11FeaturesKHR)
...
VULKAN_DEFAULT_CUSTOM_REPACK(VkPhysicalDeviceMultisampledRenderToSwapchainFeaturesEXT)
...
VULKAN_DEFAULT_CUSTOM_REPACK(VkPhysicalDeviceOpacityMicromapFeaturesKHR)
VULKAN_DEFAULT_CUSTOM_REPACK(VkPhysicalDeviceOpacityMicromapPropertiesEXT)
VULKAN_DEFAULT_CUSTOM_REPACK(VkPhysicalDeviceOpacityMicromapPropertiesKHR)
...
VULKAN_DEFAULT_CUSTOM_REPACK(VkPhysicalDevicePipelineLibraryGroupHandlesFeaturesKHR)
...
VULKAN_DEFAULT_CUSTOM_REPACK(VkPhysicalDevicePrimitiveRestartIndexFeaturesEXT)
...
VULKAN_DEFAULT_CUSTOM_REPACK(VkPhysicalDevicePrivateDataBaseHandleFeaturesNV)
...
VULKAN_DEFAULT_CUSTOM_REPACK(VkPhysicalDevicePushConstantBankFeaturesNV)
VULKAN_DEFAULT_CUSTOM_REPACK(VkPhysicalDevicePushConstantBankPropertiesNV)
...
VULKAN_DEFAULT_CUSTOM_REPACK(VkPhysicalDeviceQueuePerfHintFeaturesQCOM)
VULKAN_DEFAULT_CUSTOM_REPACK(VkPhysicalDeviceQueuePerfHintPropertiesQCOM)
...
VULKAN_DEFAULT_CUSTOM_REPACK(VkPhysicalDeviceSchedulingControlsDispatchParametersPropertiesARM)
...
VULKAN_DEFAULT_CUSTOM_REPACK(VkPhysicalDeviceShaderAbortFeaturesKHR)
VULKAN_DEFAULT_CUSTOM_REPACK(VkPhysicalDeviceShaderAbortPropertiesKHR)
...
VULKAN_DEFAULT_CUSTOM_REPACK(VkPhysicalDeviceShaderConstantDataFeaturesKHR)
...
VULKAN_DEFAULT_CUSTOM_REPACK(VkPhysicalDeviceShaderInstrumentationFeaturesARM)
VULKAN_DEFAULT_CUSTOM_REPACK(VkPhysicalDeviceShaderInstrumentationPropertiesARM)
...
VULKAN_DEFAULT_CUSTOM_REPACK(VkPhysicalDeviceShaderMixedFloatDotProductFeaturesVALVE)
...
VULKAN_DEFAULT_CUSTOM_REPACK(VkPhysicalDeviceShaderMultipleWaitQueuesFeaturesQCOM)
VULKAN_DEFAULT_CUSTOM_REPACK(VkPhysicalDeviceShaderMultipleWaitQueuesPropertiesQCOM)
...
VULKAN_DEFAULT_CUSTOM_REPACK(VkPhysicalDeviceShaderOCPMicroscalingTypesFeaturesEXT)
...
VULKAN_DEFAULT_CUSTOM_REPACK(VkPhysicalDeviceShaderSplitBarrierFeaturesEXT)
VULKAN_DEFAULT_CUSTOM_REPACK(VkPhysicalDeviceShaderSplitBarrierPropertiesEXT)
VULKAN_DEFAULT_CUSTOM_REPACK(VkPhysicalDeviceShaderSubgroupExtendedTypesFeatures)
VULKAN_DEFAULT_CUSTOM_REPACK(VkPhysicalDeviceShaderSubgroupPartitionedFeaturesEXT)
...
VULKAN_DEFAULT_CUSTOM_REPACK(VkPhysicalDeviceThrottleHintFeaturesSEC)
...
VULKAN_DEFAULT_CUSTOM_REPACK(VkPhysicalDeviceVideoEncodeFeedback2FeaturesKHR)
...
VULKAN_DEFAULT_CUSTOM_REPACK(VkPushConstantBankInfoNV)
// VULKAN_DEFAULT_CUSTOM_REPACK(VkPushConstantsInfo)
// VULKAN_DEFAULT_CUSTOM_REPACK(VkPushDataInfoEXT)
...
VULKAN_DEFAULT_CUSTOM_REPACK(VkQueryPoolVideoEncodePerPartitionFeedbackCreateInfoKHR)
...
VULKAN_DEFAULT_CUSTOM_REPACK(VkQueueFamilyDataGraphOpticalFlowPropertiesARM)
...
VULKAN_DEFAULT_CUSTOM_REPACK(VkQueueFamilyDataGraphTOSAPropertiesARM)
VULKAN_DEFAULT_CUSTOM_REPACK(VkQueueFamilyGlobalPriorityProperties)
VULKAN_DEFAULT_CUSTOM_REPACK(VkQueueFamilyOptimalImageTransferGranularityPropertiesKHR)
...
// VULKAN_DEFAULT_CUSTOM_REPACK(VkResourceDescriptorInfoEXT)
...
VULKAN_DEFAULT_CUSTOM_REPACK(VkSamplerCustomBorderColorIndexCreateInfoEXT)
...
// VULKAN_DEFAULT_CUSTOM_REPACK(VkShaderDescriptorSetAndBindingMappingInfoEXT)
VULKAN_DEFAULT_CUSTOM_REPACK(VkShaderInstrumentationCreateInfoARM)
VULKAN_DEFAULT_CUSTOM_REPACK(VkShaderInstrumentationMetricDescriptionARM)
...
VULKAN_DEFAULT_CUSTOM_REPACK(VkSharedPresentSurfaceCapabilities2KHR)
...
VULKAN_DEFAULT_CUSTOM_REPACK(VkSubsampledImageFormatPropertiesEXT)
...
VULKAN_DEFAULT_CUSTOM_REPACK(VkSwapchainFlagsSurfaceCapabilitiesEXT)
...
VULKAN_DEFAULT_CUSTOM_REPACK(VkTensorExplicitTilingFormatPropertiesARM)
...
VULKAN_DEFAULT_CUSTOM_REPACK(VkTensorRollingBackingCreateInfoARM)
...
VULKAN_DEFAULT_CUSTOM_REPACK(VkTexelBufferDescriptorInfoEXT)
VULKAN_DEFAULT_CUSTOM_REPACK(VkTextureLODGatherFormatPropertiesAMD)
VULKAN_DEFAULT_CUSTOM_REPACK(VkThrottleHintSubmitInfoSEC)
...
VULKAN_DEFAULT_CUSTOM_REPACK(VkVideoEncodeFeedback2CapabilitiesKHR)
