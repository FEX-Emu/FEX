...
#ifdef IS_32BIT_THUNK
  fexldr_ptr_libvulkan_vkCmdSetVertexInputEXT = (PFN_vkCmdSetVertexInputEXT)fexldr_ptr_libvulkan_vkGetDeviceProcAddr(out, "vkCmdSetVertexInputEXT");
...
void fexfn_impl_libvulkan_vkCmdSetVertexInputEXT(
    ...
    uint32_t BindingDescCount, guest_layout<const VkVertexInputBindingDescription2EXT*> GuestBindingDescs,
  ...
  fexldr_ptr_libvulkan_vkCmdSetVertexInputEXT(  Buffer,
                                                BindingDescCount, BindingDescs.data(),
                                                AttributeDescCount, AttributeDescs.data());
...
void fex_custom_repack_entry(host_layout<VkDescriptorGetInfoEXT>& into, const guest_layout<VkDescriptorGetInfoEXT>& from) {
  ...
  default:
    fprintf(stderr, "ERROR: Invalid descriptor type used in VkDescriptorGetInfoEXT");
    std::abort();
  }
}
