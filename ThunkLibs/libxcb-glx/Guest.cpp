...
static void InitializeExtensions(xcb_connection_t* c) { FEX_xcb_glx_init_extension(c, &xcb_glx_id); }

xcb_void_cookie_t
xcb_glx_create_context_checked(xcb_connection_t* a_0, xcb_glx_context_t a_1, xcb_visualid_t a_2, uint32_t a_3, xcb_glx_context_t a_4, uint8_t a_5) {
...
xcb_glx_get_color_table_parameterfv_reply(xcb_connection_t* a_0, xcb_glx_get_color_table_parameterfv_cookie_t a_1, xcb_generic_error_t** a_2) {
...
xcb_glx_get_color_table_parameteriv_reply(xcb_connection_t* a_0, xcb_glx_get_color_table_parameteriv_cookie_t a_1, xcb_generic_error_t** a_2) {
...
xcb_glx_get_convolution_parameterfv_reply(xcb_connection_t* a_0, xcb_glx_get_convolution_parameterfv_cookie_t a_1, xcb_generic_error_t** a_2) {
...
xcb_glx_get_convolution_parameteriv_reply(xcb_connection_t* a_0, xcb_glx_get_convolution_parameteriv_cookie_t a_1, xcb_generic_error_t** a_2) {
...
xcb_glx_get_compressed_tex_image_arb_reply(xcb_connection_t* a_0, xcb_glx_get_compressed_tex_image_arb_cookie_t a_1, xcb_generic_error_t** a_2) {
