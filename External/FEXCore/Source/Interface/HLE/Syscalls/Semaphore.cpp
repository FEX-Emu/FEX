...
namespace FEXCore::HLE {
  ...
  void RegisterSemaphore() {
    ...
    REGISTER_SYSCALL_IMPL(semop, [](FEXCore::Core::InternalThreadState *Thread, int semid, struct sembuf *sops, size_t nsops) -> uint64_t {
    ...
    REGISTER_SYSCALL_IMPL(semtimedop, [](FEXCore::Core::InternalThreadState *Thread, int semid, struct sembuf *sops, size_t nsops, const struct timespec *timeout) -> uint64_t {
