...
void InitializeSecondaryTables() {
  const U8U8InfoStruct TwoByteOpTable[] = {
    ...
    {0x0E, 1, X86InstInfo{"FEMMS",      TYPE_3DNOW_INST, FLAGS_BLOCK_END | FLAGS_NO_OVERLAY,                                                            0, nullptr}},
    ...
    {0xC4, 1, X86InstInfo{"PINSRW",  TYPE_MMX, GenFlagsSizes(SIZE_64BIT, SIZE_32BIT) | FLAGS_MODRM | FLAGS_XMM_FLAGS | FLAGS_SF_SRC_GPR,                                   1, nullptr}},
