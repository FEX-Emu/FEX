...
void InitializeSecondaryTables() {
  const U8U8InfoStruct TwoByteOpTable[] = {
    ...
    // Used by FEX to know when to do a signal reteurn
    {0x36, 1, X86InstInfo{"SIGRET",       TYPE_INST, FLAGS_BLOCK_END | FLAGS_NO_OVERLAY,                                                            0, nullptr}},

    // This was originally used by VIA to jump to its alternative instruction set
    {0x3F, 1, X86InstInfo{"ALTINST",      TYPE_INST, FLAGS_BLOCK_END | FLAGS_NO_OVERLAY,                                                            0, nullptr}},
  };
