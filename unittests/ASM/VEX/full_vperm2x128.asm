%ifdef CONFIG
{
  "HostFeatures": ["AVX"],
  "RegData": {
    "RAX": "0x0000000060276bdd",
    "RBX": "0x0000000060276bdd"
  }
}
%endif
...
; vperm2f128/vperm2i128 all the immediate encodings

vpxor ymm0, ymm0, ymm0
vpxor ymm3, ymm3, ymm3

vmovaps ymm1, [rel .random_data + ((i * 32) % 4096)]
vmovaps ymm2, [rel .random_data2 + ((i * 32) % 4096)]
vperm2f128 ymm0, ymm1, ymm2, i
vmovaps [rel .data_result_float + (i * 32)], ymm0

vmovaps ymm4, [rel .random_data + ((i * 32) % 4096)]
vmovaps ymm5, [rel .random_data2 + ((i * 32) % 4096)]
vperm2i128 ymm3, ymm4, ymm5, i
vmovaps [rel .data_result_int + (i * 32)], ymm3

; CRC32 (by 64) the results
crc32 rax, qword [rel .data_result_float + (i * 32) + 0]
crc32 rax, qword [rel .data_result_float + (i * 32) + 8]
crc32 rax, qword [rel .data_result_float + (i * 32) + 16]
crc32 rax, qword [rel .data_result_float + (i * 32) + 24]

crc32 rbx, qword [rel .data_result_int + (i * 32) + 0]
crc32 rbx, qword [rel .data_result_int + (i * 32) + 8]
crc32 rbx, qword [rel .data_result_int + (i * 32) + 16]
crc32 rbx, qword [rel .data_result_int + (i * 32) + 24]
