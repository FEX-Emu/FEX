%ifdef CONFIG
{
  "HostFeatures": ["AVX"],
  "RegData": {
    "RAX": "0x0000000094977a29",
    "RBX": "0x00000000b6cf975f"
  }
}
%endif
...
; vpermilpd all the immediate encodings

; 256-bit
vpermilpd ymm0, [rel .random_data + ((i * 32) % 4096)], i
vmovaps [rel .data_result + (i * 32)], ymm0

; 128-bit
vpermilpd xmm1, [rel .random_data + ((i * 16) % 4096)], i
