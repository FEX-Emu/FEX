%ifdef CONFIG
{
  "HostFeatures": ["AVX"],
  "RegData": {
    "RAX": "0x000000003207af7f",
    "RBX": "0x000000004da2efc7"
  }
}
%endif
...
; vshufpd all the immediate encodings

; 256-bit
vmovaps ymm1, [rel .random_data2 + ((i * 32) % 4096)]
vshufpd ymm0, ymm1, [rel .random_data + ((i * 32) % 4096)], i
vmovaps [rel .data_result + (i * 32)], ymm0

; 128-bit
vmovaps xmm3, [rel .random_data2 + ((i * 16) % 4096)]
vshufpd xmm2, xmm3, [rel .random_data + ((i * 16) % 4096)], i
