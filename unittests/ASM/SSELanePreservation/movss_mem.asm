%ifdef CONFIG
{
  "HostFeatures": ["AVX"],
  "RegData": {
    "XMM0": ["0x00000000ab3fa4a5", "0x0000000000000000", "0xccdbcfc31f3ff0f3", "0x108390defebac4be"],
    "XMM1": ["0x00000000970b4549", "0x0000000000000000", "0", "0"]
  }
}
%endif
