%ifdef CONFIG
{
  "HostFeatures": ["AVX"],
  "RegData": {
    "XMM0": ["0xbd7eb46a43cc1ad6", "0x1278f793970b4549", "0xccdbcfc31f3ff0f3", "0x108390defebac4be"],
    "XMM1": ["0x4549bd7ec4be43cc", "0xb46a12781ad6970b", "0", "0"],
...
pshufd xmm0, xmm1, 0b10001101
vpshufd xmm1, xmm2, 0b10001101
