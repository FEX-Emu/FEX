%ifdef CONFIG
{
  "HostFeatures": ["AVX"],
  "RegData": {
    "XMM0": ["0xfdecd28fab3fa4a5", "0xfdecd28fab3fa4a5", "0xccdbcfc31f3ff0f3", "0x108390defebac4be"],
    "XMM1": ["0xc4be43cc1ad6970b", "0xfdecd28fab3fa4a5", "0", "0"],
...
movhps xmm0, [rel .data]
vmovhps xmm1, xmm2, [rel .data]
