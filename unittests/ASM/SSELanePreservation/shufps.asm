%ifdef CONFIG
{
  "HostFeatures": ["AVX"],
  "RegData": {
    "XMM0": ["0xab3fa4a536d09fc2", "0x970b4549970b4549", "0xccdbcfc31f3ff0f3", "0x108390defebac4be"],
    "XMM1": ["0x1ad6970bb46a1278", "0x1ad6970b1ad6970b", "0", "0"],
...
shufps xmm0, xmm1, 0b10
vshufps xmm1, xmm2, xmm3, 0b10
