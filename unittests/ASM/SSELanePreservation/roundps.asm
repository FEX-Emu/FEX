%ifdef CONFIG
{
  "HostFeatures": ["AVX"],
  "RegData": {
    "XMM0": ["0x43cc000080000000", "0x8000000000000000", "0xccdbcfc31f3ff0f3", "0x108390defebac4be"],
    "XMM1": ["0xc4be400000000000", "0x4549c00080000000", "0", "0"],
...
roundps xmm0, xmm1, 0b00
vroundps xmm1, xmm2, 0b00
