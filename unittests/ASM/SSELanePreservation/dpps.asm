%ifdef CONFIG
{
  "HostFeatures": ["AVX"],
  "RegData": {
    "XMM0": ["0x0000000000000000", "0xfb7b8616fb7b8616", "0xccdbcfc31f3ff0f3", "0x108390defebac4be"],
    "XMM1": ["0x0000000000000000", "0x4b1efb1c4b1efb1c", "0", "0"],
...
dpps xmm0, xmm1, 0b11001100
vdpps xmm1, xmm2, xmm3, 0b11001100
