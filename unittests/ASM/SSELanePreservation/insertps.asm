%ifdef CONFIG
{
  "HostFeatures": ["AVX"],
  "RegData": {
    "XMM0": ["0x00000000ab3fa4a5", "0x7d7ccd8836d09fc2", "0xccdbcfc31f3ff0f3", "0x108390defebac4be"],
    "XMM1": ["0x000000001ad6970b", "0x4549bd7eb46a1278", "0", "0"],
...
insertps xmm0, xmm1, 0b11010010
vinsertps xmm1, xmm2, xmm3, 0b11010010
