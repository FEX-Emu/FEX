%ifdef CONFIG
{
  "HostFeatures": ["AVX"],
  "RegData": {
    "XMM0": ["0x1ad6454943cc970b", "0xbd7eb46a1278f793", "0xccdbcfc31f3ff0f3", "0x108390defebac4be"],
    "XMM1": ["0x43cc970bc4be1ad6", "0x4549bd7eb46a1278", "0", "0"],
...
pshuflw xmm0, xmm1, 0b10001101
vpshuflw xmm1, xmm2, 0b10001101
