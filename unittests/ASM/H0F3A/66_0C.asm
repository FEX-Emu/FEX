%ifdef CONFIG
{
  "RegData": {
    ...
    "XMM2": ["0x30b556de38c17718", "0x67d29af330ae762c"],
    "XMM3": ["0x41029b7f255b4cf4", "0xb76472a37404b890"],
    "XMM4": ["0x57fa6daf9af2e91c", "0x8a6789f25ffdc710"],
    "XMM5": ["0x4f1694dfa8fb773c", "0x10828c03760078c0"],
    "XMM6": ["0x2ef9bb92689712b0", "0x1ea62724c8883dfa"],
    "XMM7": ["0x1c86432298df55c8", "0x07f565f98b8db7bc"],
    "XMM8": ["0x88b0bd28710f2147", "0x099224327fb5ac38"]
  }
}
%endif
...
blendps xmm1, [rdx + 16 * 8],  0000b
blendps xmm2, [rdx + 16 * 9],  0001b
blendps xmm3, [rdx + 16 * 10], 0011b
blendps xmm4, [rdx + 16 * 11], 0111b
blendps xmm5, [rdx + 16 * 12], 1111b
blendps xmm6, [rdx + 16 * 13], 1110b
blendps xmm7, [rdx + 16 * 14], 1100b
blendps xmm8, [rdx + 16 * 15], 1000b
