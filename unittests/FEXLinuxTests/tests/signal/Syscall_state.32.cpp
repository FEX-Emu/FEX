...
__attribute__((naked)) void DoZeroRegSyscallFault(CPUState State) {
  ...
  __asm volatile(
    ...
    [RSIOffset] "i"(offsetof(CPUState, Registers[TEST_REG_ESI]) - 4), [RDIOffset] "i"(offsetof(CPUState, Registers[TEST_REG_EDI]) - 4), [RBXOffset] "i"(offsetof(CPUState, Registers[TEST_REG_EBX]) - 4),
    [RCXOffset] "i"(offsetof(CPUState, Registers[TEST_REG_ECX]) - 4), [RBPOffset] "i"(offsetof(CPUState, Registers[TEST_REG_EBP]) - 4), [FlagsOffset] "i"(offsetof(CPUState, eflags) - 4)
