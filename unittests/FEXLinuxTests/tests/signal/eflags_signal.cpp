...
#define DO_ASM(x, y) \
  __asm volatile( \
    x                                    /* Need to late move syscall number since incoming asm will overwrite eax */ \
...
TEST_CASE("Signal-Flags-CF-0") { RunTest(EFL_CF, 0, ClearCFAndWait); }
TEST_CASE("Signal-Flags-CF-1") { RunTest(EFL_CF, 1, SetCFAndWait); }
TEST_CASE("Signal-Flags-PF-0") { RunTest(EFL_PF, 0, ClearPFAndWait); }
TEST_CASE("Signal-Flags-PF-1") { RunTest(EFL_PF, 1, SetPFAndWait); }
TEST_CASE("Signal-Flags-ZF-0") { RunTest(EFL_ZF, 0, ClearZFAndWait); }
TEST_CASE("Signal-Flags-ZF-1") { RunTest(EFL_ZF, 1, SetZFAndWait); }
TEST_CASE("Signal-Flags-SF-0") { RunTest(EFL_SF, 0, ClearSFAndWait); }
TEST_CASE("Signal-Flags-SF-1") { RunTest(EFL_SF, 1, SetSFAndWait); }
TEST_CASE("Signal-Flags-OF-0") { RunTest(EFL_OF, 0, ClearOFAndWait); }
TEST_CASE("Signal-Flags-OF-1") { RunTest(EFL_OF, 1, SetOFAndWait); }
