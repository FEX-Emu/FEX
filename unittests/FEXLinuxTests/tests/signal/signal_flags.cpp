...
TEST_CASE("Signals: PF on Signal") { SetupAndCallTest(InvalidINT_SetPF, EFL_PF, 1); }

TEST_CASE("Signals: NoPF on Signal") { SetupAndCallTest(InvalidINT_ClearPF, EFL_PF, 0); }

TEST_CASE("Signals: CF on Signal") { SetupAndCallTest(InvalidINT_SetCF, EFL_CF, 1); }

TEST_CASE("Signals: NoCF on Signal") { SetupAndCallTest(InvalidINT_ClearCF, EFL_CF, 0); }

TEST_CASE("Signals: ZF on Signal") { SetupAndCallTest(InvalidINT_SetZF, EFL_ZF, 1); }

TEST_CASE("Signals: NoZF on Signal") { SetupAndCallTest(InvalidINT_ClearZF, EFL_ZF, 0); }

TEST_CASE("Signals: SF on Signal") { SetupAndCallTest(InvalidINT_SetSF, EFL_SF, 1); }

TEST_CASE("Signals: NoSF on Signal") { SetupAndCallTest(InvalidINT_ClearSF, EFL_SF, 0); }

TEST_CASE("Signals: OF on Signal") { SetupAndCallTest(InvalidINT_SetOF, EFL_OF, 1); }

TEST_CASE("Signals: NoOF on Signal") { SetupAndCallTest(InvalidINT_ClearOF, EFL_OF, 0); }
