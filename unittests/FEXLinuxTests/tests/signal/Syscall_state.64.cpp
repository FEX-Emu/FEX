...
__attribute__((naked)) void DoZeroRegSyscallFault(CPUState* State) {
  ...
  __asm volatile(
    ...
    [R10Offset] "i"(offsetof(CPUState, Registers[REG_R10]) - 8), [R8Offset] "i"(offsetof(CPUState, Registers[REG_R8]) - 8), [RSIOffset] "i"(offsetof(CPUState, Registers[REG_RSI]) - 8),
    [RDIOffset] "i"(offsetof(CPUState, Registers[REG_RDI]) - 8), [RBXOffset] "i"(offsetof(CPUState, Registers[REG_RBX]) - 8), [RCXOffset] "i"(offsetof(CPUState, Registers[REG_RCX]) - 8),
    [RBPOffset] "i"(offsetof(CPUState, Registers[REG_RBP]) - 8), [R9Offset] "i"(offsetof(CPUState, Registers[REG_R9]) - 8), [R11Offset] "i"(offsetof(CPUState, Registers[REG_R11]) - 8),
    [R12Offset] "i"(offsetof(CPUState, Registers[REG_R12]) - 8), [R13Offset] "i"(offsetof(CPUState, Registers[REG_R13]) - 8),
    [R14Offset] "i"(offsetof(CPUState, Registers[REG_R14]) - 8), [R15Offset] "i"(offsetof(CPUState, Registers[REG_R15]) - 8), [FlagsOffset] "i"(offsetof(CPUState, eflags) - 8)
