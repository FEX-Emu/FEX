...
private:
  ...
  static bool IsValidFPValueForImm8(T value) {
    const uint64_t bits = fmt::detail::bit_cast<FloatToEquivalentUInt<T>>(value);
...
protected:
  static uint32_t FP32ToImm8(float value) {
    ...
    const auto bits = fmt::detail::bit_cast<uint32_t>(value);
  ...
  static uint32_t FP64ToImm8(double value) {
    ...
    const auto bits = fmt::detail::bit_cast<uint64_t>(value);
