...
#include <FEXCore/IR/IRDefines.inc>
  ...
  IRPair<IROp_CondJump> _CondJump(OrderedNode *ssa0, CondClassType cond = CondClassType::NEQ) {
    return _CondJump(ssa0, _Constant(0), InvalidNode, InvalidNode, cond, GetOpSize(ssa0));
  }
  IRPair<IROp_CondJump> _CondJump(OrderedNode *ssa0, OrderedNode *ssa1, OrderedNode *ssa2, CondClassType cond = CondClassType::NEQ) {
