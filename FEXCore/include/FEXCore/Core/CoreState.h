...
enum FallbackHandlerIndex {
  ...
  // Float to GPR conversions
  OPINDEX_FLOAT_TOGPR_S_2,
  OPINDEX_FLOAT_TOGPR_S_4,
  OPINDEX_FLOAT_TOGPR_S_8,
  OPINDEX_FLOAT_TOGPR_ZS_2,
  OPINDEX_FLOAT_TOGPR_ZS_4,
  OPINDEX_FLOAT_TOGPR_ZS_8,
