...
TEST_CASE_METHOD(TestDisassembler, "Emitter: ALU: Carry flag invert") { TEST_SINGLE(cfinv(), "cfinv"); }
TEST_CASE_METHOD(TestDisassembler, "Emitter: ALU: Arm to eXternal FLAG") { TEST_SINGLE(axflag(), "axflag"); }
TEST_CASE_METHOD(TestDisassembler, "Emitter: ALU: eXternal to Arm FLAG") { TEST_SINGLE(xaflag(), "xaflag"); }
