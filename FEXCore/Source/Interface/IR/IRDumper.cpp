...
static void PrintArg(fextl::stringstream* out, [[maybe_unused]] const IRListView* IR, uint64_t Arg) { *out << "#0x" << std::hex << Arg; }

[[maybe_unused]] static void PrintArg(fextl::stringstream* out, [[maybe_unused]] const IRListView* IR, const char* Arg) { *out << Arg; }
...
static void PrintArg(fextl::stringstream* out, [[maybe_unused]] const IRListView* IR, CondClassType Arg) {
  ...
  static constexpr std::array<std::string_view, 22> CondNames = {
    "EQ",  "NEQ", "UGE", "ULT",  "MI",    "PL",  "VS",  "VC",   "UGT", "ULE", "SGE",
    "SLT", "SGT", "SLE", "ANDZ", "ANDNZ", "FLU", "FGE", "FLEU", "FGT", "FU",  "FNU"};
