...
bool IRCompaction::Run(IREmitter* IREmit) {
  ...
  auto LocalHeaderOp = LocalBuilder._IRHeader(
    OrderedNodeWrapper::WrapOffset(0).GetNode(ListBegin), HeaderOp->OriginalRIP, HeaderOp->BlockCount, HeaderOp->NumHostInstructions);
