...
void OpDispatchBuilder::POPFOp(OpcodeArgs) {
  ...
  uint32_t FlagsMask = ~((1U << FEXCore::X86State::RFLAG_VIP_LOC) | (1U << FEXCore::X86State::RFLAG_VIF_LOC) |
                         (1U << FEXCore::X86State::RFLAG_VM_LOC) | (1U << FEXCore::X86State::RFLAG_IOPL_LOC) |
                         (1U << FEXCore::X86State::RFLAG_RF_LOC));
