...
struct bitmap_allocator_settings {
  uint32_t bucket_sizes[3] {};
  uint32_t bucket_allocation_percentages[3] {};
};
...
private:
  ...
  constexpr static std::array<uint32_t, 3> bucket_granule_sizes = {{
    settings.bucket_sizes[0],
    settings.bucket_sizes[1],
    settings.bucket_sizes[2],
  }};
