...
void InitializeInfoTables() {
  ...
  const std::vector<std::tuple<uint8_t, uint8_t, X86InstInfo>> TwoByteOpTable = {
    ...
    {0x90, 1, X86InstInfo{"SETO",    TYPE_INST, FLAGS_MODRM | FLAGS_SF_MOD_DST,                                                                                        0, nullptr}},
    {0x91, 1, X86InstInfo{"SETNO",   TYPE_INST, FLAGS_MODRM | FLAGS_SF_MOD_DST,                                                                                        0, nullptr}},
    {0x92, 1, X86InstInfo{"SETB",    TYPE_INST, FLAGS_MODRM | FLAGS_SF_MOD_DST,                                                                                        0, nullptr}},
    {0x93, 1, X86InstInfo{"SETNB",   TYPE_INST, FLAGS_MODRM | FLAGS_SF_MOD_DST,                                                                                        0, nullptr}},
    {0x94, 1, X86InstInfo{"SETZ",    TYPE_INST, FLAGS_MODRM | FLAGS_SF_MOD_DST,                                                                                        0, nullptr}},
    {0x95, 1, X86InstInfo{"SETNZ",   TYPE_INST, FLAGS_MODRM | FLAGS_SF_MOD_DST,                                                                                        0, nullptr}},
    {0x96, 1, X86InstInfo{"SETBE",   TYPE_INST, FLAGS_MODRM | FLAGS_SF_MOD_DST,                                                                                        0, nullptr}},
    {0x97, 1, X86InstInfo{"SETNBE",  TYPE_INST, FLAGS_MODRM | FLAGS_SF_MOD_DST,                                                                                        0, nullptr}},
    {0x98, 1, X86InstInfo{"SETS",    TYPE_INST, FLAGS_MODRM | FLAGS_SF_MOD_DST,                                                                                        0, nullptr}},
    {0x99, 1, X86InstInfo{"SETNS",   TYPE_INST, FLAGS_MODRM | FLAGS_SF_MOD_DST,                                                                                        0, nullptr}},
    {0x9A, 1, X86InstInfo{"SETP",    TYPE_INST, FLAGS_MODRM | FLAGS_SF_MOD_DST,                                                                                        0, nullptr}},
    {0x9B, 1, X86InstInfo{"SETNP",   TYPE_INST, FLAGS_MODRM | FLAGS_SF_MOD_DST,                                                                                        0, nullptr}},
    {0x9C, 1, X86InstInfo{"SETL",    TYPE_INST, FLAGS_MODRM | FLAGS_SF_MOD_DST,                                                                                        0, nullptr}},
    {0x9D, 1, X86InstInfo{"SETNL",   TYPE_INST, FLAGS_MODRM | FLAGS_SF_MOD_DST,                                                                                        0, nullptr}},
    {0x9E, 1, X86InstInfo{"SETLE",   TYPE_INST, FLAGS_MODRM | FLAGS_SF_MOD_DST,                                                                                        0, nullptr}},
    {0x9F, 1, X86InstInfo{"SETNLE",  TYPE_INST, FLAGS_MODRM | FLAGS_SF_MOD_DST,                                                                                        0, nullptr}},
