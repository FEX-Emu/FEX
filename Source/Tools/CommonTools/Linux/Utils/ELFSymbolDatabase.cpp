...
uint64_t ELFSymbolDatabase::GetElfBase() const { return LocalInfo.GuestBase; }

uint64_t ELFSymbolDatabase::DefaultRIP() const { return File->GetEntryPoint() + LocalInfo.GuestBase; }
