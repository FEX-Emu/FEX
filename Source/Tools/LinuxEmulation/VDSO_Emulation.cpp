...
namespace x32 {
  ...
  namespace VDSO {
    static bool SyscallErr(uint64_t Result) { return Result >= -4095; }
...
const fextl::vector<FEXCore::IR::ThunkDefinition>& GetVDSOThunkDefinitions() { return VDSODefinitions; }

const FEXCore::Context::VDSOSigReturn& GetVDSOSymbols() { return VDSOPointers; }
} // namespace FEX::VDSO
