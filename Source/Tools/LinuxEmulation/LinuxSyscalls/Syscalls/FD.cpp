...
void RegisterFD(FEX::HLE::SyscallHandler* Handler) {
  ...
  REGISTER_SYSCALL_IMPL_PASS_FLAGS(
    fchownat, SyscallFlags::OPTIMIZETHROUGH | SyscallFlags::NOSYNCSTATEONENTRY,
  ...
  REGISTER_SYSCALL_IMPL_PASS_FLAGS(
    renameat, SyscallFlags::OPTIMIZETHROUGH | SyscallFlags::NOSYNCSTATEONENTRY,
  ...
  REGISTER_SYSCALL_IMPL_PASS_FLAGS(
    linkat, SyscallFlags::OPTIMIZETHROUGH | SyscallFlags::NOSYNCSTATEONENTRY,
  ...
  REGISTER_SYSCALL_IMPL_PASS_FLAGS(
    splice, SyscallFlags::OPTIMIZETHROUGH | SyscallFlags::NOSYNCSTATEONENTRY,
  ...
  REGISTER_SYSCALL_IMPL_PASS_FLAGS(renameat2, SyscallFlags::OPTIMIZETHROUGH | SyscallFlags::NOSYNCSTATEONENTRY,
                                   [](FEXCore::Core::CpuStateFrame* Frame, int olddirfd, const char* oldpath, int newdirfd,
                                      const char* newpath, unsigned int flags) -> uint64_t {
    // Flags don't need remapped
  ...
  REGISTER_SYSCALL_IMPL_PASS_FLAGS(
    name_to_handle_at, SyscallFlags::OPTIMIZETHROUGH | SyscallFlags::NOSYNCSTATEONENTRY,
  ...
  REGISTER_SYSCALL_IMPL_PASS_FLAGS(
    copy_file_range, SyscallFlags::OPTIMIZETHROUGH | SyscallFlags::NOSYNCSTATEONENTRY,
    [](FEXCore::Core::CpuStateFrame* Frame, int fd_in, loff_t* off_in, int fd_out, loff_t* off_out, size_t len, unsigned int flags) -> uint64_t {
    // Flags don't need remapped
  ...
  if (Handler->IsHostKernelVersionAtLeast(5, 13, 0)) {
    ...
    REGISTER_SYSCALL_IMPL_PASS_FLAGS(
      landlock_add_rule, SyscallFlags::OPTIMIZETHROUGH | SyscallFlags::NOSYNCSTATEONENTRY,
