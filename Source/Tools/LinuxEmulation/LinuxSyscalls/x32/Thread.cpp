...
void RegisterThread(FEX::HLE::SyscallHandler* Handler) {
  ...
  REGISTER_SYSCALL_IMPL_X32_PASS_MANUAL(getresuid32, getresuid,
  ...
  REGISTER_SYSCALL_IMPL_X32_PASS_MANUAL(getresgid32, getresgid,
  ...
  REGISTER_SYSCALL_IMPL_X32_PASS_MANUAL(futex_time64, futex,
                                        [](FEXCore::Core::CpuStateFrame* Frame, int* uaddr, int futex_op, int val,
                                           const struct timespec* timeout, int* uaddr2, uint32_t val3) -> uint64_t {
