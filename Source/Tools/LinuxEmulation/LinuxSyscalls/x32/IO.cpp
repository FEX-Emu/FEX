...
void RegisterIO(FEX::HLE::SyscallHandler* Handler) {
  ...
  REGISTER_SYSCALL_IMPL_X32_PASS(io_pgetevents_time64, [](FEXCore::Core::CpuStateFrame* Frame, aio_context_t ctx_id, long min_nr, long nr, struct io_event* events, struct timespec* timeout, const struct io_sigset* usig) -> uint64_t {
