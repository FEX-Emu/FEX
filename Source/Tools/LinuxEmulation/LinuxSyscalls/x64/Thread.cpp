...
void RegisterThread(FEX::HLE::SyscallHandler* Handler) {
  ...
  REGISTER_SYSCALL_IMPL_X64_FLAGS(clone, SyscallFlags::DEFAULT, clone);
  REGISTER_SYSCALL_IMPL_X64(sigaltstack, sigaltstack);
  REGISTER_SYSCALL_IMPL_X64_FLAGS(execve, SyscallFlags::DEFAULT, execve);
  REGISTER_SYSCALL_IMPL_X64_FLAGS(execveat, SyscallFlags::DEFAULT, execveat);
}
} // namespace FEX::HLE::x64
