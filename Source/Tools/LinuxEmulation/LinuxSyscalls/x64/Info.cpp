...
void RegisterInfo(FEX::HLE::SyscallHandler* Handler) {
  ...
  if (Handler->IsHostKernelVersionAtLeast(6, 6, 0)) {
    REGISTER_SYSCALL_IMPL_X64_PASS_FLAGS(map_shadow_stack, SyscallFlags::OPTIMIZETHROUGH | SyscallFlags::NOSYNCSTATEONENTRY, [](FEXCore::Core::CpuStateFrame* Frame, uint64_t addr, uint64_t size, uint32_t flags) -> uint64_t {
