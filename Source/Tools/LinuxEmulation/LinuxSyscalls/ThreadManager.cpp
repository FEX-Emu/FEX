...
namespace FEX::HLE {
  FEX::HLE::ThreadStateObject *ThreadManager::CreateThread(uint64_t InitialRIP, uint64_t StackPointer, FEXCore::Core::CPUState *NewThreadState, uint64_t ParentTID) {
    auto ThreadStateObject = new FEX::HLE::ThreadStateObject;
    ThreadStateObject->ThreadManager.parent_tid = ParentTID;
  ...
  void ThreadManager::DestroyThread(FEX::HLE::ThreadStateObject *Thread) {
    {
  ...
  void ThreadManager::HandleThreadDeletion(FEX::HLE::ThreadStateObject *Thread) {
