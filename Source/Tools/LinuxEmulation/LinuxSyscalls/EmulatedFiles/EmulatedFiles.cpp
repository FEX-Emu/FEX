...
static void SealTmpFD(int fd) { fcntl(fd, F_ADD_SEALS, F_SEAL_SEAL | F_SEAL_SHRINK | F_SEAL_GROW | F_SEAL_WRITE | F_SEAL_FUTURE_WRITE); }
...
#define FLAG(flag, name) \
  if (flag) { \
    ...
    FLAG(false, "tpr_shadow")
      ...
      FLAG(false, "ept_ad") FLAG(res_7.ebx & (1 << 0), "fsgsbase") FLAG(res_7.ebx & (1 << 1), "tsc_adjust") FLAG(
        res_7.ebx & (1 << 3), "bmi1") FLAG(res_7.ebx & (1 << 4), "hle") FLAG(res_7.ebx & (1 << 5), "avx2")
        FLAG(res_7.ebx & (1 << 7), "smep") FLAG(res_7.ebx & (1 << 8), "bmi2") FLAG(res_7.ebx & (1 << 9), "erms") FLAG(res_7.ebx & (1 << 10), "invpcid") FLAG(
          res_7.ebx & (1 << 11),
          "rtm") FLAG(false, // Needs leaf support
                      "cqm")
          FLAG(res_7.ebx & (1 << 14),
               "mpx") FLAG(false, // Needs leaf support
                           "rdt_a") FLAG(res_7.ebx & (1 << 16), "avx512f") FLAG(res_7.ebx & (1 << 17), "avx512dq") FLAG(res_7.ebx & (1 << 18), "rdseed")
            FLAG(res_7.ebx & (1 << 19), "adx") FLAG(res_7.ebx & (1 << 20), "smap") FLAG(res_7.ebx & (1 << 21), "avx512ifma") FLAG(res_7.ebx & (1 << 23), "clflushopt") FLAG(
              res_7.ebx & (1 << 24), "clwb") FLAG(res_7.ebx & (1 << 25), "intel_pt") FLAG(res_7.ebx & (1 << 26), "avx512pf") FLAG(res_7.ebx & (1 << 27), "avx512er")
              FLAG(res_7.ebx & (1 << 28), "avx512cd") FLAG(res_7.ebx & (1 << 29), "sha_ni") FLAG(res_7.ebx & (1 << 30), "avx512bw") FLAG(
                res_7.ebx & (1 << 31),
                "avx512vl") FLAG(false, // Needs leaf support // res_d.eax & (1 << 0) // Leaf 1h
                                 "xsaveopt")
      ...
      FLAG(false, "hwp") FLAG(false, "hwp_notify") FLAG(false, "hwp_act_window") FLAG(false, "hwp_epp") FLAG(false, "hwp_pkg_req")
        ...
        FLAG(res_8000_000a.ebx & (1 << 0), "npt") FLAG(res_8000_000a.ebx & (1 << 1), "lbrv") FLAG(res_8000_000a.ebx & (1 << 2), "svm_lock") FLAG(
          res_8000_000a.ebx & (1 << 3),
          "nrip_save") FLAG(res_8000_000a.ebx & (1 << 4), "tsc_scale") FLAG(res_8000_000a.ebx & (1 << 5), "vmcb_clean") FLAG(res_8000_000a.ebx & (1 << 6), "flushbyasid")
          FLAG(res_8000_000a.ebx & (1 << 7), "decodeassists") FLAG(res_8000_000a.ebx & (1 << 10), "pausefilter") FLAG(res_8000_000a.ebx & (1 << 12), "pfthreshold") FLAG(
            res_8000_000a.ebx & (1 << 13), "avic") FLAG(res_8000_000a.ebx & (1 << 15), "v_vmsave_vmload") FLAG(res_8000_000a.ebx & (1 << 16), "vgif")

            FLAG(res_7.ecx & (1 << 1), "avx512vbmi") FLAG(res_7.ecx & (1 << 2), "umip") FLAG(res_7.ecx & (1 << 3), "pku") FLAG(res_7.ecx & (1 << 4), "ospke") FLAG(
              res_7.ecx & (1 << 5), "waitpkg") FLAG(res_7.ecx & (1 << 6), "avx512_vbmi2") FLAG(res_7.ecx & (1 << 8), "gfni") FLAG(res_7.ecx & (1 << 9), "vaes")
              FLAG(res_7.ecx & (1 << 10), "vpclmulqdq") FLAG(res_7.ecx & (1 << 11), "avx512_vnni") FLAG(res_7.ecx & (1 << 12), "avx512_"
                                                                                                                               "bitalg") FLAG(
                res_7.ecx & (1 << 13), "tme") FLAG(res_7.ecx & (1 << 14), "avx512_vpopcntdq") FLAG(res_7.ecx & (1 << 16), "la57") FLAG(res_7.ecx & (1 << 22), "rdpid")
                FLAG(res_7.ecx & (1 << 25), "cldemote") FLAG(res_7.ecx & (1 << 27), "movdiri") FLAG(res_7.ecx & (1 << 28), "movdir64b")

                  FLAG(res_8000_0007.ebx & (1 << 0), "overflow_recov") FLAG(res_8000_0007.ebx & (1 << 1), "succor") FLAG(res_8000_0007.ebx & (1 << 3), "smca")

                    FLAG(res_7.edx & (1 << 2), "avx512_4vnniw") FLAG(res_7.edx & (1 << 3), "avx512_4fmaps") FLAG(res_7.edx & (1 << 4), "fsr"
                                                                                                                                       "m") FLAG(
                      res_7.edx & (1 << 8),
                      "avx512_vp2intersect") FLAG(res_7.edx & (1 << 10), "md_clear") FLAG(res_7.edx & (1 << 14), "serialize") FLAG(res_7.edx & (1 << 18), "pconfig")
                      FLAG(res_7.edx & (1 << 19), "arch_lbr") FLAG(res_7.edx & (1 << 28), "flush_l1d") FLAG(res_7.edx & (1 << 29), "arch_"
                                                                                                                                   "capabil"
                                                                                                                                   "ities")
  }
...
EmulatedFDManager::EmulatedFDManager(FEXCore::Context::Context* ctx)
  ...
  FDReadCreators["/proc/sys/kernel/osrelease"] = [&](FEXCore::Context::Context* ctx, int32_t fd, const char* pathname, int32_t flags, mode_t mode) -> int32_t {
    ...
    char Tmp[64] {};
    snprintf(Tmp, sizeof(Tmp), "%d.%d.%d\n", FEX::HLE::SyscallHandler::KernelMajor(GuestVersion), FEX::HLE::SyscallHandler::KernelMinor(GuestVersion), FEX::HLE::SyscallHandler::KernelPatch(GuestVersion));
  ...
  FDReadCreators["/proc/version"] = [&](FEXCore::Context::Context* ctx, int32_t fd, const char* pathname, int32_t flags, mode_t mode) -> int32_t {
    ...
    snprintf(Tmp, sizeof(Tmp), kernel_version, FEX::HLE::SyscallHandler::KernelMajor(GuestVersion), FEX::HLE::SyscallHandler::KernelMinor(GuestVersion), FEX::HLE::SyscallHandler::KernelPatch(GuestVersion));
    // + 1 to ensure null at the end
    write(FD, Tmp, strlen(Tmp) + 1);
    lseek(FD, 0, SEEK_SET);
    SealTmpFD(FD);
...
int32_t EmulatedFDManager::OpenAt(int dirfs, const char* pathname, int flags, uint32_t mode) {
  ...
  if (Creator == FDReadCreators.end()) {
    if (
      ((pathname && pathname[0] != '/') || // If pathname exists then it must not be absolute
       !pathname) &&
      dirfs != AT_FDCWD) {
