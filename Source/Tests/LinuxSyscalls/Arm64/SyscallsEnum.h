...
enum Syscalls_Arm64 {
  ...
  SYSCALL_Arm64_mmap = ~0,
  SYSCALL_Arm64_truncate = ~0,
  SYSCALL_Arm64_ftruncate = ~0,
  SYSCALL_Arm64_profil = ~0,
  SYSCALL_Arm64_statfs = ~0,
  SYSCALL_Arm64_fstatfs = ~0,
  SYSCALL_Arm64_ioperm = ~0,
  SYSCALL_Arm64_socketcall = ~0,
  SYSCALL_Arm64_stat = ~0,
  SYSCALL_Arm64_lstat = ~0,
  SYSCALL_Arm64_fstat = ~0,
