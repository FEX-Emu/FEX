...
namespace FEX::HLE {
  void RegisterIO() {
    ...
    REGISTER_SYSCALL_IMPL_PASS_FLAGS(iopl, SYSCALL_FLAG_OPTIMIZETHROUGH | SYSCALL_FLAG_NOSYNCSTATEONENTRY,
      [](FEXCore::Core::CpuStateFrame *Frame, int level) -> uint64_t {
      // Just claim we don't have permission
      return -EPERM;
    });

    REGISTER_SYSCALL_IMPL_PASS_FLAGS(ioperm, SYSCALL_FLAG_OPTIMIZETHROUGH | SYSCALL_FLAG_NOSYNCSTATEONENTRY,
    ...
    REGISTER_SYSCALL_IMPL_PASS_FLAGS(io_setup, SYSCALL_FLAG_OPTIMIZETHROUGH | SYSCALL_FLAG_NOSYNCSTATEONENTRY,
    ...
    REGISTER_SYSCALL_IMPL_PASS_FLAGS(io_destroy, SYSCALL_FLAG_OPTIMIZETHROUGH | SYSCALL_FLAG_NOSYNCSTATEONENTRY,
      [](FEXCore::Core::CpuStateFrame *Frame, aio_context_t ctx_id) -> uint64_t {
      uint64_t Result = ::syscall(SYSCALL_DEF(io_destroy), ctx_id);
      SYSCALL_ERRNO();
    });

    REGISTER_SYSCALL_IMPL_PASS_FLAGS(io_submit, SYSCALL_FLAG_OPTIMIZETHROUGH | SYSCALL_FLAG_NOSYNCSTATEONENTRY,
    ...
    REGISTER_SYSCALL_IMPL_PASS_FLAGS(io_cancel, SYSCALL_FLAG_OPTIMIZETHROUGH | SYSCALL_FLAG_NOSYNCSTATEONENTRY,
    ...
    REGISTER_SYSCALL_IMPL_PASS_FLAGS(ioprio_set, SYSCALL_FLAG_OPTIMIZETHROUGH | SYSCALL_FLAG_NOSYNCSTATEONENTRY,
      [](FEXCore::Core::CpuStateFrame *Frame, int which, int who) -> uint64_t {
      uint64_t Result = ::syscall(SYSCALL_DEF(ioprio_set), which, who);
      SYSCALL_ERRNO();
    });

    REGISTER_SYSCALL_IMPL_PASS_FLAGS(ioprio_get, SYSCALL_FLAG_OPTIMIZETHROUGH | SYSCALL_FLAG_NOSYNCSTATEONENTRY,
