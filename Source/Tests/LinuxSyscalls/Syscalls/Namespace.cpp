...
namespace FEX::HLE {
  void RegisterNamespace(FEX::HLE::SyscallHandler *const Handler) {
    ...
    if (Handler->GetHostKernelVersion() >= FEX::HLE::SyscallHandler::KernelVersion(5, 1, 0)) {
      REGISTER_SYSCALL_IMPL_PASS_FLAGS(open_tree, SYSCALL_FLAG_OPTIMIZETHROUGH | SYSCALL_FLAG_NOSYNCSTATEONENTRY,
      ...
      REGISTER_SYSCALL_IMPL_PASS_FLAGS(move_mount, SYSCALL_FLAG_OPTIMIZETHROUGH | SYSCALL_FLAG_NOSYNCSTATEONENTRY,
      ...
      REGISTER_SYSCALL_IMPL_PASS_FLAGS(fsopen, SYSCALL_FLAG_OPTIMIZETHROUGH | SYSCALL_FLAG_NOSYNCSTATEONENTRY,
      ...
      REGISTER_SYSCALL_IMPL_PASS_FLAGS(fsconfig, SYSCALL_FLAG_OPTIMIZETHROUGH | SYSCALL_FLAG_NOSYNCSTATEONENTRY,
      ...
      REGISTER_SYSCALL_IMPL_PASS_FLAGS(fsmount, SYSCALL_FLAG_OPTIMIZETHROUGH | SYSCALL_FLAG_NOSYNCSTATEONENTRY,
      ...
      REGISTER_SYSCALL_IMPL_PASS_FLAGS(fspick, SYSCALL_FLAG_OPTIMIZETHROUGH | SYSCALL_FLAG_NOSYNCSTATEONENTRY,
        [](FEXCore::Core::CpuStateFrame *Frame, int dfd, const char *path, unsigned int flags) -> uint64_t {
    ...
    if (Handler->GetHostKernelVersion() >= FEX::HLE::SyscallHandler::KernelVersion(5, 12, 0)) {
      REGISTER_SYSCALL_IMPL_PASS_FLAGS(mount_setattr, SYSCALL_FLAG_OPTIMIZETHROUGH | SYSCALL_FLAG_NOSYNCSTATEONENTRY,
