...
namespace FEX::HLE {
  void RegisterIOUring(FEX::HLE::SyscallHandler *const Handler) {
    ...
    if (Handler->IsHostKernelVersionAtLeast(5, 1, 0)) {
      REGISTER_SYSCALL_IMPL_PASS_FLAGS(io_uring_setup, SYSCALL_FLAG_OPTIMIZETHROUGH | SYSCALL_FLAG_NOSYNCSTATEONENTRY,
      ...
      REGISTER_SYSCALL_IMPL_PASS_FLAGS(io_uring_enter, SYSCALL_FLAG_OPTIMIZETHROUGH | SYSCALL_FLAG_NOSYNCSTATEONENTRY,
      ...
      REGISTER_SYSCALL_IMPL_PASS_FLAGS(io_uring_register, SYSCALL_FLAG_OPTIMIZETHROUGH | SYSCALL_FLAG_NOSYNCSTATEONENTRY,
