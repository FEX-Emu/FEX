...
namespace FEX::HLE {
  void RegisterSHM() {
    ...
    REGISTER_SYSCALL_IMPL_PASS_FLAGS(shmget, SYSCALL_FLAG_OPTIMIZETHROUGH | SYSCALL_FLAG_NOSYNCSTATEONENTRY,
    ...
    REGISTER_SYSCALL_IMPL_PASS_FLAGS(shmctl, SYSCALL_FLAG_OPTIMIZETHROUGH | SYSCALL_FLAG_NOSYNCSTATEONENTRY,
