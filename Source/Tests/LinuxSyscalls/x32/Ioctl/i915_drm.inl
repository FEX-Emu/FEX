...
// XXX: _BASIC_META(DRM_IOCTL_I915_BATCHBUFFER)
// XXX: _BASIC_META(DRM_IOCTL_I915_IRQ_EMIT)
_BASIC_META(DRM_IOCTL_I915_IRQ_WAIT)
// XXX: _BASIC_META(DRM_IOCTL_I915_GETPARAM)
_BASIC_META(DRM_IOCTL_I915_SETPARAM)
// XXX: _BASIC_META(DRM_IOCTL_I915_ALLOC)
_BASIC_META(DRM_IOCTL_I915_FREE)
_BASIC_META(DRM_IOCTL_I915_INIT_HEAP)
// XXX: _BASIC_META(DRM_IOCTL_I915_CMDBUFFER)
...
_BASIC_META(DRM_IOCTL_I915_GEM_EXECBUFFER2_WR)
...
_BASIC_META(DRM_IOCTL_I915_GEM_MMAP_OFFSET)
...
_BASIC_META(DRM_IOCTL_I915_GEM_CONTEXT_CREATE_EXT)
